#!/usr/bin/env python3
"""
Portable Calendar Sync Script
This script will automatically install required packages if they're missing.
"""
...
# Now import the actual script functionality
import pandas as pd
import datetime
import json
import pickle
...
def sync_down_to_excel(service):
    ...
    df_display.index = df_display.index.tz_localize(None)
