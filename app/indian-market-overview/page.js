...
import Link from 'next/link'; // Optional: if you want to link back or to the PDF
    ...
    <main className={styles.articleContainer}>
      ...
      <section className={styles.section}>
        ...
        <div className={styles.chartContainer}>
          <Image
            src="/public/Resources/indian market overview/real-gdp-growth.png" // ** UPDATE PATH IF NEEDED **
        ...
        <div className={styles.chartContainer}>
          <Image
            src="/public/Resources/indian market overview/gdp-contribution.png" // ** UPDATE PATH IF NEEDED **
            //image: '/public/Resources/indian market overview/real-gdp-growth.png'
            alt="India GDP Contribution by Sector (2023-2024 %)"
            width={800}
            height={400}
            className={styles.chartImage}
          />
           <p className={styles.chartCaption}>GDP Contribution Breakdown. Source: MOSPI (Ministry of Statistics and Programme Implementation), DPIIT & Invest India sector reports, Quantwater Analysis</p>
        </div>
      ...
      <section className={styles.section}>
        ...
        <div className={styles.chartGrid}>
          <div className={styles.chartContainer}>
            <Image
              src="/public/Resources/indian market overview/inflation-trends.png" // ** UPDATE PATH IF NEEDED **
          ...
          <div className={styles.chartContainer}>
            <Image
              src="/public/Resources/indian market overview/rbi-repo-rate.png" // ** UPDATE PATH IF NEEDED **
        ...
        <p>
         ...
         <div className={styles.chartContainer}>
          <Image
            src="/public/Resources/indian market overview/fiscal-deficit.png" // ** UPDATE PATH IF NEEDED **
       ...
       <section className={styles.section}>
        ...
        <p>
         ...
         <div className={styles.chartGrid}>
          <div className={styles.chartContainer}>
            <Image
              src="/public/Resources/indian market overview/cmp-inr-1.png" // ** UPDATE PATH IF NEEDED **
              //src="/public/Resources/indian market overview/cmp-inr-2.png"
              alt="Major Indices Performance (10 Years, INR)"
              width={600}
              height={350}
              className={styles.chartImage}
            />
            <p className={styles.chartCaption}>Major Index Performance - 10 Years (INR, Indexed). Source: Quantwater Analysis (Illustrative)</p>
          </div>
          <div className={styles.chartContainer}>
            <Image
              //src="/public/Resources/indian market overview/cmp-inr-1.png" // ** UPDATE PATH IF NEEDED **
              src="/public/Resources/indian market overview/cmp-inr-2.png"
              alt="Major Indices Performance (6 Years, INR)"
              width={600}
              height={350}
              className={styles.chartImage}
            />
            <p className={styles.chartCaption}>Major Index Performance - 6 Years (INR, Indexed). Source: Quantwater Analysis (Illustrative)</p>
          </div>
          <div className={styles.chartContainer}>
            <Image
              //src="/public/Resources/indian market overview/cmp-inr-1.png" // ** UPDATE PATH IF NEEDED **
              src="/public/Resources/indian market overview/cmp-inr-density-plot1.png"
              alt="Density Plot Nifty 50 (10 Years, INR)"
              width={600}
              height={350}
              className={styles.chartImage}
            />
            <p className={styles.chartCaption}>Density Plot Nifty 50 (10 Years, INR). Source: Quantwater Analysis (Illustrative)</p>
          </div>
          <div className={styles.chartContainer}>
            <Image
              src="/images/indian-market/nifty50-volatility-inr.png" // ** UPDATE PATH IF NEEDED **
              alt="Nifty 50 Rolling Volatility (1 Month, INR)"
              width={600}
              height={350}
              className={styles.chartImage}
            />
             <p className={styles.chartCaption}>Market Volatility Trends. Source: Quantwater Analysis (Illustrative)</p>
          </div>
        </div>
         <p>
      ...
      <section className={styles.section}>
         ...
         <div className={styles.chartContainer}>
          <Image
            src="/images/indian-market/yield-curve-trend.png" // ** UPDATE PATH IF NEEDED **
       ...
       <section className={styles.section}>
         ...
         <div className={styles.chartGrid}>
           <div className={styles.chartContainer}>
            <Image
              src="/images/indian-market/fdi-sector-inflow-chart.png" // ** UPDATE PATH IF NEEDED **
           ...
           <div className={styles.chartContainer}>
            <Image
              src="/images/indian-market/inr-usd-exchange-rate-chart.png" // ** UPDATE PATH IF NEEDED **
      ...
      <footer className={styles.articleFooter}>
        ...
        {/* Optional: Link back to resources or to download the PDF */}
